...
You should get a little raffle id at the top, be sure to leave this tab open and reuse it. You don't want to lose out on winning the testing JS course.
...
One other note here as you're voting, I know it's a "quiz" but these are really more polls. There's no correct answer, no winners or losers because if you already know what I'm talking about, you're on team toby, and if you don't you're on team michael *and* get the bonus of learning today, so no-win situation.
